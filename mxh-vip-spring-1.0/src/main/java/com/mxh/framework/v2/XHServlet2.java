...
/**
 * 这是手写spring1.0中的v2优化版本。
 * 优化项：1、doDispatcher方法在v2版本中，url参数还是静态代码，需要改为url参数动态获取。
 */
public class XHServlet2 extends HttpServlet {
    ...
    private void doDispatcher(HttpServletRequest req, HttpServletResponse resp) throws Exception {
      ...
      //2、根据url在handlerMapping中找到对应的method
        ...
        method.invoke(ioc.get(beanName),paramterValues);
    }
